...
INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE) 
	VALUES (1, 1, 1, 1, 4, 'AM372RR', 2, TO_Date( '10/10/2008', 'MM/DD/YYYY'), TO_Date( '10/23/2008', 'MM/DD/YYYY'), TO_Date( '10/23/2008', 'MM/DD/YYYY'), 24990, 25500, 1 );
INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE) 
	VALUES (2, 2, 3, 3, 3, 'AM472RR', 3, TO_Date( '11/10/2013', 'MM/DD/YYYY'), TO_Date( '11/13/2013', 'MM/DD/YYYY'), TO_Date( '12/13/2013', 'MM/DD/YYYY'), 29000, 30000, 1 );
INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE,montant_remise,pourcentage_remise) 
	VALUES (3, 1, 1, 1, 4, 'AM372RR', 2, TO_Date( '10/30/2011', 'MM/DD/YYYY'), TO_Date( '11/02/2011', 'MM/DD/YYYY'), TO_Date( '11/02/2011', 'MM/DD/YYYY'), 124990, 125500, 1 ,0,10);
	INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE,montant_remise,pourcentage_remise) 
	VALUES (4, 1, 1, 1, 4, 'AM372RR', 2, TO_Date( '09/28/2008', 'MM/DD/YYYY'), TO_Date( '10/03/2011', 'MM/DD/YYYY'), TO_Date( '10/03/2011', 'MM/DD/YYYY'), 56400, 57500, 1 ,20,0);