...
INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE,montant_remise,pourcentage_remise) 
	VALUES (4, 1, 1, 1, 4, 'KK030QQ', 2, TO_Date( '09/28/2008', 'MM/DD/YYYY'), TO_Date( '10/03/2008', 'MM/DD/YYYY'), TO_Date( '10/03/2008', 'MM/DD/YYYY'), 56400, 57500, 1 ,20,0);
INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE,montant_remise,pourcentage_remise) 
	VALUES (5, 2, 1, 1, 1, 'XM111AL', 2, TO_Date( '01/15/2014', 'MM/DD/YYYY'), TO_Date( '02/15/2014', 'MM/DD/YYYY'), TO_Date( '02/15/2014', 'MM/DD/YYYY'), 43623, 43623, 0 ,0,0);