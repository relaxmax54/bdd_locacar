...
ALTER TABLE DOSSIERS 	ADD (
	...
	REFERENCES	VEHICULES(id_agence),
	...
	CONSTRAINT	dos_km_depart_fk FOREIGN KEY (km_depart)
	REFERENCES	VEHICULES(KM_PARCOURUS),
	);	
...
INSERT INTO TARIFS (ID_TARIF, ID_CATEGORIE, NOM, PRIX_JOUR, PRIX_FORFAIT, KM_AUTORISES, PRIX_KM) VALUES (0, 4, 'TARIF_PAR_DEFAUT', 0, 0, 0, 0 );
...
INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE,montant_remise,pourcentage_remise) 
	VALUES (3, 1, 1, 2, 4, 'AM372RR', 2, TO_Date( '10/30/2011', 'MM/DD/YYYY'), TO_Date( '11/02/2011', 'MM/DD/YYYY'), TO_Date( '11/02/2011', 'MM/DD/YYYY'), 50000, 50700, 1 ,0,10);
INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE,montant_remise,pourcentage_remise) 
	VALUES (4, 1, 1, 1, 4, 'KK030QQ', 2, TO_Date( '09/28/2008', 'MM/DD/YYYY'), TO_Date( '10/03/2008', 'MM/DD/YYYY'), TO_Date( '10/03/2008', 'MM/DD/YYYY'), 87000, 87800, 1 ,20 ,0);
INSERT INTO DOSSIERS (ID_DOSSIER, ID_CLIENT, ID_AGENCE_RESERVATION, ID_AGENCE_RETRAIT, ID_AGENCE_RETOUR, NUM_IMMATRICULATION, ID_TARIF, DATE_RETRAIT, DATE_RETOUR_PREVU, DATE_RETOUR_EFFECTIF, KM_DEPART, KM_ARRIVEE, ASSURANCE_PRISE,montant_remise,pourcentage_remise) 
	VALUES (5, 2, 1, 1, 1, 'XM111AL', 2, TO_Date( '01/15/2014', 'MM/DD/YYYY'), TO_Date( '02/15/2014', 'MM/DD/YYYY'), TO_Date( '02/15/2014', 'MM/DD/YYYY'), 80000, 80150, 0, 0, 0);
